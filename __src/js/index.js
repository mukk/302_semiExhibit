(function() {
	...
	if(_ua.Mobile){
		...
		if(screen.width<=1400){MAX_X = 100;MAX_Y = 20;frameAmp = 25;}
	...
	if(!webgl_flg){
		...
		// var VIEW_ANGLE = 45, ASPECT = waveWidth / waveHeight, NEAR = 1, FAR = 300;
		...
		spot1.position.set(0, 0, 100);
		spot1.target.position.set(0,0,0);
		scene.add(spot1);

		var spot2 = new THREE.SpotLight(0xff0000);
		spot2.position.set(0, 40, 100);
		spot2.target.position.set(0,40,0);
		scene.add(spot2);

		var spot3 = new THREE.SpotLight(0x00ff00);
		spot3.position.set(0, -50, 100);
		spot3.target.position.set(0,250,0);
		scene.add(spot3);
